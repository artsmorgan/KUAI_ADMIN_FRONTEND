                    ...
                    <div className="flex-area conten container-fluid">
                        <div className="mod-rest-container">
                            <div className="row clearfix">
                                ...
                                <div
                                    className={"col-md-4 col-lg-4 col-sm-12 col-xs-12 " + (this.state.formTab.categoriesTab ? '' : 'hidden')}>
                                    <h3 className="mb-hidden">
                                        Categorías
                                    </h3>
                                    <div className="rotator-container">
                                        <button className="btn-theme btn-cat" onClick={this.showCategoryModal}><span>+</span>NUEVA CATEGORÍA</button>
                                        <Modal
                                            ...
                                            <Modal.Body>
                                                <form onSubmit={this.formSubmitHandler}>
                                                    <div className="ls-panel">
                                                        <input type="text" className={"uni-input"} name="name" placeholder="Category name"
                                ...
                                <div
                                    className={"col-md-4 col-lg-4 col-sm-12 col-xs-12 " + (this.state.formTab.menuTab ? '' : 'hidden')}>
                                        ...
                                        <div className="rotator-scroll">
                                            <div className="rotator-stripe">
                                                ...
                                                <div className="rotator">
                                                    ...
                                                    <div className="img"
                                                         style={{background: "url(" + menuImage + ")"}}></div>
                                ...
                                <div
                                    className={"col-md-4 col-lg-4 col-sm-12 col-xs-12 " + (this.state.formTab.newMenuItem ? '' : 'hidden')}>
                                        ...
                                        <div className="menu-elements">
                                            ...
                                            <div className="photo-area">
                                                ...
                                                <div className="promo-area">
                                                    <p>
                                                        <Checkbox name="aceptarReservaciones"/>
                                                        <label htmlFor="" className="chk-label">Añadir un producto
                                                            gratuito</label>
                                                    </p>
                                                    <div className="promo-code">
                                                        <label htmlFor="">
