    ...
    renderMethods() {
        return <>
            <div className="collapse-container ca-delivery">
                ...
                <div
                    className={"collapse-content " + (this.state.dataToPost.comerRestauranteEnabled ? '' : 'collapse')}>
                    <div className="col">
            ...
            <div className={"collapse-end " + (this.state.dataToPost.expressEnabled ? '' : 'collapse')}>
                <div className="col">
                    ...
                    <label htmlFor="" className="chk-label" style={{fontSize: '13px', fontWeight: '500'}}>Envío
                        gratis</label>
