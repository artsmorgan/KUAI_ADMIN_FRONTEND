                                ...
                                <form onSubmit={this.formSubmitHandler}>
                                    <div className="row clearfix">
                                        ...
                                        <div className="col col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                            ...
                                            <input type="file" id="my_file" style={{ display: "none" }} onChange={this.fileUploadOnchange} ref={this.fileUpload} />
                                            <div className="cover-pic">
                                                <label htmlFor="">Editar foto de perfil y </label>
                                                <div className="cvr">
                                                    <div className="cvr-main">
                                                        <div className="overlay">
                                                            <button type="button" className="btn-cvr-change" onClick={this.showFileUpload}>
                                                    ...
                                                    <div className="cvr-photo">
                                                        <div className="overlay">
                                                            <button type="button" className="btn-photo-change" onClick={this.showFileUpload}>
                                                                <svg width="13" height="13" viewBox="0 0 13 13"
                                                                    fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
