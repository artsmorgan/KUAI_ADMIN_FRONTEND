                                    ...
                                    <div className="row clearfix">
                                        <div className="col col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                            ...
                                            <div>
                                                ...
                                                <input className="uni-input" type="text" name="nombre" placeholder="nombre"
                                                    onChange={this.inputChangeHandler} value={this.state.dataToPost.nombre} />
                                                <p style={{ color: "red" }}>
                                                    {this.validator.message('nombre', this.state.dataToPost.nombre, 'required')}
                                                </p>
                                                <label htmlFor="">ADMINISTRADOR:</label>
                                                <input className="uni-input" type="text" name="administrador" placeholder="administrador"
                                                    onChange={this.inputChangeHandler} value={this.state.dataToPost.administrador} />
                                                <p style={{ color: "red" }}>
                                                ...
                                                <input className="uni-input md" type="text" name="facebook" placeholder="facebook"
                                                    onChange={this.inputChangeHandler} value={this.state.dataToPost.facebook} />
                                                <p style={{ color: "red" }}>
                                                ...
                                                <input className="uni-input md" type="text" name="instagram" placeholder="instagram"
                                                    onChange={this.inputChangeHandler} value={this.state.dataToPost.instagram} />
                                                <p style={{ color: "red" }}>
                                        ...
                                        <div className="col col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                            ...
                                            <div>
                                                ...
                                                <Select className="cstm-select" options={optionProvince} name="provincia" placeholder="Provincia"
                                                    onChange={this.selectChangeHandler} value={this.state.dataToPost.provincia} />
                                                <p style={{ color: "red" }}>
                                                    {this.validator.message('provincia', this.state.dataToPost.provincia, 'required')}
                                                </p>
                                                <label htmlFor="">CANTON:</label>
                                                <Select className="cstm-select" options={optionCanton} name="canton" placeholder="Canton"
                                                    onChange={this.selectChangeHandler} value={this.state.dataToPost.canton} />
                                                <p style={{ color: "red" }}>
                                                    {this.validator.message('canton', this.state.dataToPost.canton, 'required')}
                                                </p>
                                                <label htmlFor="">DISTRITO:</label>
                                                <Select className="cstm-select" options={optionDistrito} name="distrito" placeholder="Distrito"
                                                    onChange={this.selectChangeHandler} value={this.state.dataToPost.distrito} />
                                                <p style={{ color: "red" }}>
                                                    {this.validator.message('distrito', this.state.dataToPost.distrito, 'required')}
                                                </p>
                                                <label htmlFor="">BARRIO:</label>
                                                <Select className="cstm-select" options={optionBarrio} name="barrio" placeholder="Barrio"
                                                    onChange={this.selectChangeHandler} value={this.state.dataToPost.barrio} />
                                                <p style={{ color: "red" }}>
                                                    {this.validator.message('barrio', this.state.dataToPost.barrio, 'required')}
                                                </p>
                                                <label htmlFor="">Direccion:</label>
                                                <textarea className="uni-input tarea" name="direccion" placeholder="Direccion"
                                                    onChange={this.inputChangeHandler} value={this.state.dataToPost.direccion} id="" cols="30" rows="10"></textarea>
                                                <p style={{ color: "red" }}>
                                        ...
                                        <div className="col col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                            ...
                                            <div className="hor-inline">
                                                <Checkbox
                                                    onChange={this.checkboxChangeHandler} name="horario-0" value="0" checked={this.state.checked} className={""}
                                            ...
                                            <div className="hor-inline">
                                                <Checkbox
                                                    onChange={this.checkboxChangeHandler} name="horario-1" value="0" checked={this.state.checked} className={"horario-1"}
                                            ...
                                            <div className="hor-inline">
                                                <Checkbox
                                                    onChange={this.checkboxChangeHandler} name="horario-2" checked={this.state.checked} className={""}
