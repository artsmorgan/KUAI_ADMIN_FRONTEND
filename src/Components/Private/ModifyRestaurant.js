                            ...
                            <form onSubmit={this.formSubmitHandler}>
                                <div className="row clearfix">
                                    ...
                                    <div className={"col col-md-4 col-lg-4 col-sm-12 col-xs-12 "+(this.state.formTab.scheduleTab ? '' : 'hidden')}>
                                        ...
                                        <div className="hor-inline">
                                            <Checkbox
                                                onChange={this.harioCheckboxChangeHandler} name="horario1"
                                                value="Martes"
                                        ...
                                        <div className="hor-inline">
                                            <Checkbox
                                                onChange={this.harioCheckboxChangeHandler} name="horario2"
                                                value="Miercoles"
                                        ...
                                        <div className="hor-inline">
                                            <Checkbox
                                                onChange={this.harioCheckboxChangeHandler} name="horario3"
                                                value="Jueves"
                                        ...
                                        <div className="hor-inline">
                                            <Checkbox
                                                onChange={this.harioCheckboxChangeHandler} name="horario4"
                                                value="Viernes"
                                        ...
                                        <div className="hor-inline">
                                            <Checkbox
                                                onChange={this.harioCheckboxChangeHandler} name="horario5"
                                                value="Sabado"
                                        ...
                                        <div className="hor-inline">
                                            <Checkbox
                                                onChange={this.harioCheckboxChangeHandler} name="horario6"
                                                value="Domingo"
