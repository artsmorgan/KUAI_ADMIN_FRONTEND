...
import LoaderInScreen from "./LoaderInScreen";
import $ from 'jquery'
...
class Login extends React.Component {
  ...
  render() {
    return (
      ...
      <>
      {this.props.auth.loading ? <LoaderInScreen /> : ''}
